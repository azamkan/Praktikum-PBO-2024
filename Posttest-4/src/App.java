...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // ProduserList.add(new Produser("Ambawomin", "Jalan Elang"));
        ...
        while (true) {
            System.out.print("""
                    ...
                    4. Tampilkan Robot
                    5. Tampilkan Produser (Alamat dan Nama)
                    6. Tampilkan Nama Produser
                    7. Tampilkan Alamat Produser
                    8. Tampilkan Service Center
                    0. Keluar
                    ==============================
                    """);
                    ...
                    if (menu1.equals("1")) {
                        ...
                        System.out.println("======= Nama Produser ========");
                        if (ProduserList.size() != 0) {
                            for (int i = 0; i < ProduserList.size(); i++) {
                                ProduserList.get(i).Lihat(1);
                                System.out.println("==============================");
                            }             
                        } else {
                            System.out.println("Tidak ada data");
                        ...
                        System.out.println("======= Alamat Produser ======");
                        if (ProduserList.size() != 0) {
                            for (int i = 0; i < ProduserList.size(); i++) {
                                ProduserList.get(i).Lihat("Alamat");
                                System.out.println("==============================");
                            }
                        } else {
                            System.out.println("Tidak ada data");
